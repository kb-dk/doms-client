...
public class Fixer {
    ...
    public void removeOriginalTitel(Document doc){
        Node badtitle = xpath.selectNode(doc,
                                         "/pb:PBCoreDescriptionDocument/pb:pbcoreTitle[pb:titleType='originaltitel']/pb:title");
    ...
    public void removeEpisodeTitel(Document doc){
        Node badtitle = xpath.selectNode(doc,
                                         "/pb:PBCoreDescriptionDocument/pb:pbcoreTitle[pb:titleType='episodetitel']/pb:title");
        if (badtitle != null && badtitle.getFirstChild() == null){
            Node parent = badtitle.getParentNode();
            parent.getParentNode().removeChild(parent);
        }
    ...
    public void removeForfatter(Document doc){
        Node badtitle = xpath.selectNode(doc,
                                         "/pb:PBCoreDescriptionDocument/pb:pbcoreCreator[pb:creatorRole='forfatter']/pb:creator");
        if (badtitle != null && badtitle.getFirstChild() == null){
            Node parent = badtitle.getParentNode();
            parent.getParentNode().removeChild(parent);
        }
    ...
    public void removeDateIssued(Document doc){
        Node badnode = xpath.selectNode(doc,
                                         "/pb:PBCoreDescriptionDocument/pb:pbcoreInstantiation/pb:dateIssued");
    ...
    public void setFormatLocation(Document doc){
        Node badnode = xpath.selectNode(doc,
                                         "/pb:PBCoreDescriptionDocument/pb:pbcoreInstantiation/pb:formatLocation");
    ...
    public void removeFormatDuration(Document doc){
        Node badnode = xpath.selectNode(doc,
                                         "/pb:PBCoreDescriptionDocument/pb:pbcoreInstantiation/pb:formatDuration");
        if (badnode != null && (badnode.getFirstChild() == null || badnode.getFirstChild().getNodeValue().equals("0"))){
            badnode.getParentNode().removeChild(badnode);
        }
    }
    ...
    public void removeDateCreated(Document doc){
        Node badnode = xpath.selectNode(doc,
                                         "/pb:PBCoreDescriptionDocument/pb:pbcoreInstantiation/pb:dateCreated");
        if (badnode != null && (badnode.getFirstChild() == null || badnode.getFirstChild().getNodeValue().equals("0"))){
            badnode.getParentNode().removeChild(badnode);
        }
    }
    ...
    public void removeFormatAspectRatio(Document doc){
        Node badnode = xpath.selectNode(doc,
                                         "/pb:PBCoreDescriptionDocument/pb:pbcoreInstantiation/pb:formatAspectRatio");
        if (badnode != null && (badnode.getFirstChild() == null || badnode.getFirstChild().getNodeValue().equals(", "))){
            badnode.getParentNode().removeChild(badnode);
        }
    }
