...
public class ModsHelper {
    ...
    private static final String INVALID_ATTRIBUTE_STRING = "---INVALID-ATTRIBUTE-PLACEHOLDER---";
    ...
    public String modsString = "<mods:mods xmlns:mods=\"http://www.loc.gov/mods/v3\">\n" +
            ...
            "        <mods:identifier type=\"reel number\" "+ INVALID_ATTRIBUTE_STRING + ">400022028241-1</mods:identifier>\n" +
